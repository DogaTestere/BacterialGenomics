...
// !TODO: thread_val probably needs to be globally available
/*
...
workflow {
    // Fastq files should have fastq or gz, if they are paired they contain 1 or 2 in their names somehwere
    fastq_ch = channel.fromFilePairs("../FastqFiles/*_{1,2}.{fastq,fastq.gz}")
